...
class GraphFlag extends StatefulWidget {
  GraphFlag({Key? key}) : super(key: key);

  @override
  State<GraphFlag> createState() => _GraphFlagState();
}

class _GraphFlagState extends State<GraphFlag> {
  String? uid;
  int sumSunD = 0,
      sumMonD = 0,
      sumTueD = 0,
