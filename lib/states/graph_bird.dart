...
class GraphBird extends StatefulWidget {
  GraphBird({Key? key}) : super(key: key);

  @override
  State<GraphBird> createState() => _GraphBirdState();
}

class _GraphBirdState extends State<GraphBird> {
  String? uid;
  int sumSunD = 0,
      sumMonD = 0,
      sumTueD = 0,
  ...
  Widget build(BuildContext context) => DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("Graph Rabbit Counting"),
            bottom: TabBar(
