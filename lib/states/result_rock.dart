...
class ResultRock extends StatefulWidget {
  const ResultRock({Key? key}) : super(key: key);

  @override
  _ResultRockState createState() => _ResultRockState();
}

class _ResultRockState extends State<ResultRock> {
  late String uid;
  List<int> times = [];
                  ...
                  GestureDetector(
                    onTap: () async {
                      Navigator.pushNamedAndRemoveUntil(context,
                          MyConstant.routeCountTimeRock, (route) => false);
                    },
                    child: Container(
                      height: 50.0,
                      width: 350,
