...
class GraphRock extends StatefulWidget {
  GraphRock({Key? key}) : super(key: key);

  @override
  State<GraphRock> createState() => _GraphRockState();
}

class _GraphRockState extends State<GraphRock> {
  String? uid;
  int sumSunD = 0,
      sumMonD = 0,
      sumTueD = 0,
  ...
  Widget build(BuildContext context) => DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text("Graph Rock Paper Scissors"),
            bottom: TabBar(
