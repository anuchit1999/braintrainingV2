...
class ResultFingermath extends StatefulWidget {
  const ResultFingermath({Key? key}) : super(key: key);

  @override
  _ResultFingermathState createState() => _ResultFingermathState();
}

class _ResultFingermathState extends State<ResultFingermath> {
  late String uid;
  List<int> times = [];
                  ...
                  GestureDetector(
                    onTap: () async {
                      Navigator.pushNamedAndRemoveUntil(
                          context,
                          MyConstant.routeCountTimeFingermath,
                          (route) => false);
                    },
                    child: Container(
                      height: 50.0,
