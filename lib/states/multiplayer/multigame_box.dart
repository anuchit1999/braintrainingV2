...
class Multi_GameBox extends StatefulWidget {
  const Multi_GameBox({Key? key}) : super(key: key);

  @override
  _Multi_GameBoxState createState() => _Multi_GameBoxState();
}

class _Multi_GameBoxState extends State<Multi_GameBox> {
  int timebox = 0,
      myAnswer = 0,
      score = 0,
      playTime = 0,
