...
class PreBird extends StatefulWidget {
  const PreBird({Key? key}) : super(key: key);

  @override
  _PreBirdState createState() => _PreBirdState();
}

class _PreBirdState extends State<PreBird> {
  int count = 3;
    ...
    await Timer(duration, () {
      if (count == 0) {
        ...
        Navigator.pushNamedAndRemoveUntil(
            context, MyConstant.routeMulti_GameBird, (route) => false);
      } else {
